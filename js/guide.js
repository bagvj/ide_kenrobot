define(['eventcenter','jquery','hardware','kenrobotJsPlumb','defaultJs'],function(eventcenter,$,hardware,kenrobotJsPlumb,defaultJs){
    ...
    function step1(){
    	...
    	$(".nav-second .scmk .content-container li:first-child").css({"z-index":1000,
    ...
    function step1Close(){
    	$(".nav-second .scmk .content-container li:first-child").css({"z-index":"998",
    ...
    function step3(){
    	$(".nav-second .ypzmk .content-container li:nth-child(2)").css({"z-index":1000,
                                                                      "background-color":"white"});
    ...
    function step3Close(){
    	$(".nav-second .ypzmk .content-container li:nth-child(2)").css({"z-index":998,
                                                                      "background-color":"white"});

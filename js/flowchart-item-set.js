...
define(["jquery"],function($){
	var data={
		...
		"hardware_board_item":{
			...
			"desc":"",
			"points":[
				{"position":[0.16,0.05,0,0],"source":true,"target":false,"color":"#FF0","shape":"Rectangle","port":"A0"},
				{"position":[0.34,0.05,0,0],"source":true,"target":false,"color":"#FF0","shape":"Rectangle","port":"B0"},
				{"position":[0.66,0.05,0,0],"source":true,"target":false,"color":"#FF0","shape":"Rectangle","port":"C0"},
				{"position":[0.84,0.05,0,0],"source":true,"target":false,"color":"#FF0","shape":"Rectangle","port":"D0"},
				{"position":[0.16,0.95,0,0],"source":true,"target":false,"color":"#FF0","shape":"Rectangle","port":"E0"},
				{"position":[0.34,0.95,0,0],"source":true,"target":false,"color":"#FF0","shape":"Rectangle","port":"F0"},
				{"position":[0.66,0.95,0,0],"source":true,"target":false,"color":"#FF0","shape":"Rectangle","port":"G0"},
				{"position":[0.84,0.95,0,0],"source":true,"target":false,"color":"#FF0","shape":"Rectangle","port":"H0"},
			]
		},
		//LED灯
		"hardware_light_item":{

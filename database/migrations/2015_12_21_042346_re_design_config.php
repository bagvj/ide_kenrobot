...
class ReDesignConfig extends Migration {
	...
	public function up() {
		...
		DB::statement("insert  into `params`(`id`,`software_id`,`is_init`,`name`,`type`,`input_type`,`default_value`,`options`,`label`,`placeholder`,`auto_set`) values (1,5,0,'condition','','text','Condition','','分支条件','',0),(2,6,0,'condition','','text','Condition','','循环条件','',0),(3,8,0,'index','','text','i','','循环变量','',0),(4,8,0,'count','','text','5','','循环次数','数字或者变量',0),(5,9,0,'time','','text','1000','','延时','毫秒',0),(6,10,0,'var','','text','Var','','变量','',0),(7,10,0,'exp','','text','Exp','','表达式','',0),(8,12,0,'port','','text','Port','','端口','',1),(9,12,0,'bit','','text','Bit','','位','',1),(10,12,0,'value','','text','Key','','读取到变量','',0),(11,13,0,'port','','text','Port','','端口','',1),(12,13,0,'bit','','text','Bit','','位','',1),(13,13,0,'value','','text','Switch','','读取到变量','',0),(14,14,0,'port','','text','Port','','端口','',1),(15,14,0,'bit','','text','Bit','','位','',1),(16,14,0,'value','','text','TravelSwitch','','读取到变量','',0),(17,15,0,'port','','text','Port','','端口','',1),(18,15,0,'bit','','text','Bit','','位','',1),(19,15,0,'value','','text','Line','','读取到变量','',0),(20,16,0,'port','','text','Port','','端口','',1),(21,16,0,'bit','','text','Bit','','位','',1),(22,16,0,'value','','text','FlameDigital','','读取到变量','',0),(23,17,0,'port','','text','Port','','端口','',1),(24,17,0,'bit','','text','Bit','','位','',1),(25,17,0,'value','','text','InfraredReception','','读取到变量','',0),(26,18,0,'port','','text','Port','','端口','',1),(27,18,0,'bit','','text','Bit','','位','',1),(28,18,0,'value','','text','Voice','','读取到变量','',0),(29,19,0,'port','','text','Port','','端口','',1),(30,19,0,'bit','','text','Bit','','位','',1),(31,19,0,'value','','text','Lean','','读取到变量','',0),(32,20,0,'port','','text','Port','','端口','',1),(33,20,0,'bit','','text','Bit','','位','',1),(34,20,0,'value','','text','Metal','','读取到变量','',0),(35,21,0,'port','','text','Port','','端口','',1),(36,21,0,'bit','','text','Bit','','位','',1),(37,21,0,'value','','text','Value','','读取到变量','',0),(38,22,1,'port','','text','Port','','端口','',1),(39,23,0,'port','','text','Port','','端口','',1),(40,23,0,'bit','','text','Bit','','位','',1),(41,23,0,'value','','text','1','','输出值','1亮/0灭',0),(42,24,0,'port','','text','Port','','端口','',1),(43,24,0,'bit','','text','Bit','','位','',1),(44,24,0,'value','','text','1','','输出值','0或1',0),(45,25,0,'port','','text','Port','','端口','',1),(46,25,0,'bit','','text','Bit','','位','',1),(47,25,0,'value','','text','1','','输出值(0/1)','0或1',0),(48,26,0,'port','','text','Port','','端口','',1),(49,26,0,'bit','','text','Bit','','位','',1),(50,26,0,'value','','text','1','','输出值','0或1',0),(51,27,0,'port','','text','Port','','端口','',1),(52,27,0,'bit','','text','Bit','','位','',1),(53,27,0,'value','','text','1','','输出值','0或1',0),(54,28,1,'port','','text','Port','','端口','',1),(55,28,0,'num','','text','Num','','显示数值','',0),(56,29,0,'index','','text','Index','','编号','0或1',0),(57,29,0,'degree','','text','Degree','','转动角度','-90~90',0),(58,30,0,'index','','text','Index','','编号','0或1',0),(59,30,0,'rotation','','text','Rotation','','转动量','-255~255',0),(60,31,0,'bit','','text','Bit','','位号','',1),(61,31,0,'value','','text','Light','','读取到变量','',0),(62,32,0,'bit','','text','Bit','','位号','',1),(63,32,0,'value','','text','Tem','','读取到变量','',0),(64,33,0,'bit','','text','Bit','','位号','',1),(65,33,0,'value','','text','Tem','','读取到变量','',0),(66,34,0,'bit','','text','Bit','','位号','',1),(67,34,0,'value','','text','PM','','读取到变量','',0),(68,35,0,'bit','','text','Bit','','位号','',1),(69,35,0,'value','','text','FlameAnalog','','读取到变量','',0),(70,36,0,'bit','','text','Bit','','位号','',1),(71,36,0,'value','','text','ADDefault','','读取到变量','',0),(72,37,1,'index','','text','Index','','串口号','0或1',0),(73,37,1,'baudRate','','text','1','','波特率','0-5,分别表示4800,9600,19200,38400,57600,115200',0),(74,37,1,'check','','text','2','','校验位','0奇校验;1偶校验;2无校验',0),(75,37,0,'index','','text','Index','','串口号','0或1',0),(76,37,0,'value','','text','UARTInput','','读取到变量','',0),(77,38,1,'index','','text','Index','','串口号','0或1',0),(78,38,1,'baudRate','','text','1','','波特率','0-5,分别表示4800,9600,19200,38400,57600,115200',0),(79,38,1,'check','','text','2','','校验位','0奇校验;1偶校验;2无校验',0),(80,38,0,'index','','text','1','','串口号','0或1',0),(81,38,0,'value','','text','UARTOutput','','输出值','',0),(82,39,1,'register','','text','Register','','波特率寄存器','0-1023',0),(83,39,1,'preFeequency','','text','PreFeequency','','预分频','0-3,分别表示1,4,16,64',0),(84,39,0,'arg','','text','240','','参数','',0),(85,39,0,'value','','text','Ultrasound','','读取到变量','',0),(86,40,1,'register','','text','Register','','波特率寄存器','0-1023',0),(87,40,1,'preFeequency','','text','PreFeequency','','预分频','0-3,分别表示1,4,16,64',0),(88,40,0,'arg','','text','254','','参数','',0),(89,40,0,'value','','text','EleCompass','','读取到变量','',0),(90,41,1,'register','','text','Register','','波特率寄存器','0-1023',0),(91,41,1,'preFeequency','','text','PreFeequency','','预分频','0-3,分别表示1,4,16,64',0),(92,41,0,'arg','','text','Add','','参数','',0),(93,41,0,'value','','text','I2CInput','','读取到变量','',0),(94,42,1,'register','','text','Register','','波特率寄存器','0-1023',0),(95,42,1,'preFeequency','','text','PreFeequency','','预分频','0-3,分别表示1,4,16,64',0),(96,42,0,'arg','','text','Add','','参数','',0),(97,42,0,'value','','text','Value','','输出值','',0)");

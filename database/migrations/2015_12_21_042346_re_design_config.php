...
class ReDesignConfig extends Migration {
	...
	public function up() {
		...
		DB::statement("insert  into `boards`(`id`,`name`,`board_type`,`image`,`thumbnail`,`in_use`) values (1,'Arduino UNO R3','uno','arduino-uno-r3.png','arduino-uno-r3-small.png',1),(2,'Arduino Yún','yun','arduino-uno-r3.png','arduino-uno-r3-small.png',1),(3,'Arduino Mega ADK','megaADK','arduino-uno-r3.png','arduino-uno-r3-small.png',1),(4,'Arduino Micro','micro','arduino-uno-r3.png','arduino-uno-r3-small.png',1),(5,'Arduino Esplora','esplora','arduino-uno-r3.png','arduino-uno-r3-small.png',1),(6,'Arduino Ethernet','ethernet','arduino-uno-r3.png','arduino-uno-r3-small.png',1),(7,'Arduino Fio','fio','arduino-uno-r3.png','arduino-uno-r3-small.png',1),(8,'Arduino LilyPadUSB','LilyPadUSB','arduino-uno-r3.png','arduino-uno-r3-small.png',1),(9,'Arduino Robot Control','robotControl','arduino-uno-r3.png','arduino-uno-r3-small.png',1),(10,'Arduino Robot Motor','robotMotor','arduino-uno-r3.png','arduino-uno-r3-small.png',1);");
	}

...
class ReDesignConfig extends Migration {
	...
	public function up() {
		...
		Schema::create('ports', function (Blueprint $table) {
			...
			$table->string('name')->comment("端口名字")->default('');
		...
		DB::statement("insert  into `components`(`id`,`name`,`label`,`in_use`,`width`,`height`,`varName`,`varCode`,`headCode`,`setupCode`,`category`) values (1,'buzzer','蜂鸣器',1,85,80,'buzzer_','int \$NAME = \$P0;\n','','','one-port-bottom'),(2,'servo','舵机',1,125,106,'servo_','Servo \$NAME;\n','#include <Servo.h>\n','\$NAME.attach(\$P0);\n','one-port-bottom'),(3,'lcd','1602',1,170,92,'lcd_','LiquidCrystal \$NAME(\$P0);\n','#include <Servo.h>\n','\$NAME.begin(16, 2);\n\$NAME.clear();\n','two-port-top'),(4,'led','LED',1,55,83,'led_','int \$NAME = \$P0;\n','','pinMode(\$NAME, OUTPUT);\n','one-port-bottom'),(5,'ultrasoundSensor','超声波',1,120,79,'ultrasound_sensor_','US \$NAME(\$P0, \$P1);\n','#include <US.h>\n#include <Servo.h>\n#include <SoftwareSerial.h>\n#include <Wire.h>\n','','two-port-bottom'),(6,'button','按钮',1,90,73,'button_','int \$NAME = \$P0;\n','','pinMode(\$NAME, INPUT);\n','one-port-bottom'),(7,'buttonPanel','按键矩阵',1,165,120,'button_panel_','ButtonPad \$NAME(\$P0);\n','#include <ButtonPad.h>\n#include <Servo.h>\n#include <SoftwareSerial.h>\n#include <Wire.h>\n','','one-port-top'),(8,'infraredSensor','光电对管',1,90,78,'infrared_sensor_','int \$NAME = \$P0;\n','','pinMode(\$NAME, INPUT);\n','one-port-bottom'),(9,'lineFollower','循迹矩阵',1,95,87,'line_follower_','LineFollower \$NAME(\$P0, \$P1);\n','#include <LineFollower.h>\n#include <Servo.h>\n#include <SoftwareSerial.h>\n#include <Wire.h>\n','','two-port-bottom'),(10,'joystick','摇杆',1,100,101,'joystick_','Joystick \$NAME(\$P1, \$P2, \$P0);\n','#include <Joystick.h>\n#include <Wire.h>\n#include <Servo.h>\n#include <SoftwareSerial.h>\n','','joystick'),(11,'lightSensor','光敏电阻',1,90,64,'light_sensor_','int \$NAME = \$P0;\n','','pinMode(\$NAME, INPUT);\n','one-port-top'),(12,'potentiometer','电位器',1,65,103,'potentiometer_','int \$NAME = \$P0;\n','','pinMode(\$NAME, INPUT);\n','one-port-top'),(13,'bluetooth','蓝牙模块',1,115,88,'bluetooth_','bqSoftwareSerial \$NAME(\$P0, \$P1, 9600);\n','#include <SoftwareSerial.h>\n#include <bqSoftwareSerial.h>\n#include <Servo.h>\n#include <Wire.h>\n','','two-port-bottom'),(14,'serialPort','串口模块',1,115,71,'serial_port_','bqSoftwareSerial \$NAME(0, 1, 9600);\n','#include <SoftwareSerial.h>\n#include <bqSoftwareSerial.h>\n#include <Servo.h>\n#include <Wire.h>\n','','one-port-right');");
		DB::statement("insert  into `ports`(`id`,`name`,`label`,`type`,`owner_id`,`owner_type`) values (1,'0','0',0,1,1),(2,'1','1',0,1,1),(3,'2','2',0,1,1),(4,'3','3',0,1,1),(5,'4','4',0,1,1),(6,'5','5',0,1,1),(7,'6','6',0,1,1),(8,'7','7',0,1,1),(9,'8','8',0,1,1),(10,'9','9',0,1,1),(11,'10','10',0,1,1),(12,'11','11',0,1,1),(13,'12','12',0,1,1),(14,'13','13',0,1,1),(15,'A0','A0',1,1,1),(16,'A1','A1',1,1,1),(17,'A2','A2',1,1,1),(18,'A3','A3',1,1,1),(19,'A4','A4',1,1,1),(20,'A5','A5',1,1,1),(21,'SerialPort','SerialPort',3,1,1),(22,'P0','P0',0,1,0),(23,'P0','P0',0,2,0),(24,'P0','SDA',1,3,0),(25,'P1','SCL',1,3,0),(26,'P0','P0',0,4,0),(27,'P0','TRI',0,5,0),(28,'P1','ECH',0,5,0),(29,'P0','P0',0,6,0),(30,'P0','P0',1,7,0),(31,'P0','P0',0,8,0),(32,'P0','P0',0,9,0),(33,'P1','P1',0,9,0),(34,'P0','KVG',0,10,0),(35,'P1','XVG',1,10,0),(36,'P2','YVG',1,10,0),(37,'P0','P0',1,11,0),(38,'P0','P0',1,12,0),(39,'P0','RXD',1,13,0),(40,'P1','TXD',1,13,0),(41,'P0','P0',3,14,0);");
	}

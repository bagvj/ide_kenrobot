...
class ReDesignConfig extends Migration {
	...
	public function up() {
		...
		Schema::create('boards', function (Blueprint $table) {
			...
			$table->string('image')->comment("主板图片");
			$table->string('thumbnail')->comment("主板缩略图");
			$table->boolean('in_use')->comment("是否正在使用");
		});
		...
		Schema::create('components', function (Blueprint $table) {
			...
			$table->integer('module_id')->comment("器件类型");
			$table->string('image')->comment("器件图片");
			$table->string('thumbnail')->comment("器件缩略图");
			$table->boolean('in_use')->comment("是否正在使用");
		});
		...
		DB::statement("insert  into `boards`(`id`,`name`,`board_type`,`image`,`thumbnail`,`in_use`) values (1,'Arduino UNO R3','uno','arduino-uno-r3.png','arduino-uno-r3-small.png',1),(2,'Arduino Nano','nano','arduino-uno-r3.png','arduino-uno-r3-small.png',1),(3,'Arduino Leonardo','leonardo','arduino-uno-r3.png','arduino-uno-r3-small.png',1),(4,'Arduino LilyPad','lilypad','arduino-uno-r3.png','arduino-uno-r3-small.png',1),(5,'Arduino Mega 2560','mega','arduino-uno-r3.png','arduino-uno-r3-small.png',1),(6,'Arduino Ethernet','ethernet','arduino-uno-r3.png','arduino-uno-r3-small.png',1),(7,'Arduino Yún','yun','arduino-uno-r3.png','arduino-uno-r3-small.png',1),(8,'Arduino Gemma','gemma','arduino-uno-r3.png','arduino-uno-r3-small.png',1),(9,'Arduino Robot Motor','robotMotor','arduino-uno-r3.png','arduino-uno-r3-small.png',1),(10,'Arduino Mini','mini','arduino-uno-r3.png','arduino-uno-r3-small.png',1),(11,'Arduino Micro','micro','arduino-uno-r3.png','arduino-uno-r3-small.png',1);");
		DB::statement("insert  into `components`(`id`,`name`,`module_id`,`image`,`thumbnail`,`in_use`) values (1,'器件-1-1',2,'test.png','test-small.png',1),(2,'器件-1-2',2,'test.png','test-small.png',1),(3,'器件-1-3',2,'test.png','test-small.png',1),(4,'器件-1-4',2,'test.png','test-small.png',1),(5,'器件-1-5',2,'test.png','test-small.png',1),(6,'器件-1-6',2,'test.png','test-small.png',1),(7,'器件-1-7',2,'test.png','test-small.png',1),(8,'器件-1-8',2,'test.png','test-small.png',1),(9,'器件-1-9',2,'test.png','test-small.png',1),(10,'器件-1-10',2,'test.png','test-small.png',1),(11,'器件-2-1',3,'test.png','test-small.png',1),(12,'器件-2-2',3,'test.png','test-small.png',1),(13,'器件-2-3',3,'test.png','test-small.png',1),(14,'器件-2-4',3,'test.png','test-small.png',1),(15,'器件-2-5',3,'test.png','test-small.png',1),(16,'器件-2-6',3,'test.png','test-small.png',1),(17,'器件-2-7',3,'test.png','test-small.png',1),(18,'器件-2-8',3,'test.png','test-small.png',1),(19,'器件-2-9',3,'test.png','test-small.png',1),(20,'器件-2-10',3,'test.png','test-small.png',1),(21,'器件-3-1',4,'test.png','test-small.png',1),(22,'器件-3-2',4,'test.png','test-small.png',1),(23,'器件-3-3',4,'test.png','test-small.png',1),(24,'器件-3-4',4,'test.png','test-small.png',1),(25,'器件-3-5',4,'test.png','test-small.png',1),(26,'器件-3-6',4,'test.png','test-small.png',1),(27,'器件-3-7',4,'test.png','test-small.png',1),(28,'器件-3-8',4,'test.png','test-small.png',1),(29,'器件-3-9',4,'test.png','test-small.png',1),(30,'器件-3-10',4,'test.png','test-small.png',1),(31,'器件-4-1',5,'test.png','test-small.png',1),(32,'器件-4-2',5,'test.png','test-small.png',1),(33,'器件-4-3',5,'test.png','test-small.png',1),(34,'器件-4-4',5,'test.png','test-small.png',1),(35,'器件-4-5',5,'test.png','test-small.png',1),(36,'器件-4-6',5,'test.png','test-small.png',1),(37,'器件-4-7',5,'test.png','test-small.png',1),(38,'器件-4-8',5,'test.png','test-small.png',1),(39,'器件-4-9',5,'test.png','test-small.png',1),(40,'器件-4-10',5,'test.png','test-small.png',1),(41,'器件-5-1',6,'test.png','test-small.png',1),(42,'器件-5-2',6,'test.png','test-small.png',1),(43,'器件-5-3',6,'test.png','test-small.png',1),(44,'器件-5-4',6,'test.png','test-small.png',1),(45,'器件-5-5',6,'test.png','test-small.png',1),(46,'器件-5-6',6,'test.png','test-small.png',1),(47,'器件-5-7',6,'test.png','test-small.png',1),(48,'器件-5-8',6,'test.png','test-small.png',1),(49,'器件-5-9',6,'test.png','test-small.png',1),(50,'器件-5-10',6,'test.png','test-small.png',1);");
	}

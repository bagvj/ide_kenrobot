define(['vendor/jquery', 'vendor/jquery-ui', 'vendor/bootstrap', 'vendor/bootstrap-typeahead', './EventManager', './util', './hardware'], function(_, _, _, _, EventManager, util, hardware) {
	var current;
	var components;
	var list;
